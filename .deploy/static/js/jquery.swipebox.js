...
;(function (window, document, $, undefined) {
	...
	$.swipebox = function(elem, options) {
		...
		html = '<div id="swipebox-overlay">\
				...
				<div id="caption"><div id="caption-wrap" class="center"></div</div>\
		...
		var ui = {
			...
			setTitle : function (index, isFirst){
				...
				if( elements[index] !== undefined )
					...
					$('#caption-wrap').append('<h4 class="tasteis blue">Taste Is</h4><h2 class=\"quote blue oswald\">'+_quote+'</h2><h3 class=\"name\">'+_name+'</h3><p class=\"title\">'+_title+'</p>');
